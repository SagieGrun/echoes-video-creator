      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-16">
          <div className="flex justify-center items-center gap-1 mb-4">
            {[1,2,3,4,5].map((star) => (
              <span key={star} className="text-coral-400 text-2xl">★</span>
            ))}
          </div>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {testimonials.map((testimonial, index) => (
            <div key={index} className="bg-white/80 rounded-2xl p-8 hover:shadow-lg transition-shadow duration-300 border border-rose-100">
              <div className="text-4xl text-coral-400 mb-4">"</div>
              ...
              <div className="border-t border-rose-200 pt-4">
                ...
                <p className="text-rose-600 text-sm">{testimonial.role}</p>
              </div>
            </div>
          ))}
        </div>
